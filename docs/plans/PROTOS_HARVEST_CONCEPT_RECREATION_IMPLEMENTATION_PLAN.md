...
| 9 — Release candidate and rollout | **Complete** | `09df142b8fe68862c33e529c419d0392b0840e65` | `2293ed7a5cd5b7feea250b83ad500128831542af` | Godot `4.7.2.stable.official.ed1daf0bf` release gate passed: import, lint, GDScript budgets, **220-asset/1,093-codepoint** integrity, **2,142/2,142** smoke checks, **31/31** dossier, **4/4** atlas, **63/63** responsive, **14/14** overlay/nearby, **27/27** Phase B, **21/21** Phase C, unchanged P11 hash, bounded boot, Web export, and independent PCK boot. Required HTML/JS/WASM/PCK/WebP files returned correct MIME types. Six final Xvfb captures passed. Local served-Web and production accepted title → field → dossier → Inspect input with no application, WebAssembly, MIME, or resource errors. | Source pushed fast-forward to shared `main`. WebDev checkpoint [`b8d92987`](manus-webdev://b8d92987) deployed `/manus-storage/proto-isometric_19eaaf43.pck` (76,121,880 bytes; SHA-256 `02b8564dee1b366ce641d1f7c5b651bd61b1d0b3e4a69580d6d9eae51b36c0e3`) at [walkers-wake-f5qxn5w7.manus.space](https://walkers-wake-f5qxn5w7.manus.space/). | Rollback is verified structurally: set `[features] interaction_dossier_v2=false` to restore the preserved legacy presenter, or select the preceding WebDev checkpoint/PCK. The deployed PCK is preserved under `/home/ubuntu/webdev-static-assets/proto-isometric/2293ed7a5cd5b7feea250b83ad500128831542af/`. |
