...
|---:|---|---|---|---|---|---|
| 0 — Baseline and audit synthesis | **Verified; ready for phase commit/push** | `8e0d04f19dd60558d7b4d6d65bc7e227d5d30f46` | Pending | **`verify.sh --release` 2142/2142 passed** after integrating the gathering/farming merge. Godot `4.7.2.stable.official.ed1daf0bf`; P11 1,000-day hash `162fc7dec14149a3ea7beb67007b8be8cc474a310ecd87cacee19061b4f37270`; `[PCK_BOOT_PASS]`; `[PASS] Protos Harvest --release`; interaction inspection **19/19**; interaction Phase C **21/21**; Xvfb terrain/pond/facility captures passed in both orientations. Durable evidence: [`PROTOS_HARVEST_CONCEPT_DOSSIER_PHASE0_BASELINE.md`](../release/PROTOS_HARVEST_CONCEPT_DOSSIER_PHASE0_BASELINE.md). | Pending fast-forward push to `main` | The default-off feature flag has no runtime consumer. Concurrent wild-flora art changed field pixels but not the audited interaction discrepancy. |
| 1 — Pure contracts and truth discipline | Not started | Phase 0 completion revision | — | — | — | Feature flag remains off. |
| 2 — Safe area and portrait sheet | Not started | Phase 1 completion revision | — | — | — | Feature flag remains off by default. |
| 3 — Desktop terrain dossier | Not started | Phase 2 completion revision | — | — | — | No unsupported Soil/Ecology telemetry. |
| 4 — Desktop object dossier | Not started | Phase 3 completion revision | — | — | — | Truthful canonical facility only. |
| 5 — Target overlay | Not started | Phase 4 completion revision | — | — | — | One input-transparent overlay. |
| 6 — Nearby-interest index | Not started | Phase 5 completion revision | — | — | — | Bounded tile-distance query only. |
| 7 — HUD/input/accessibility/localization | Not started | Phase 6 completion revision | — | — | — | Default-on decision is gated here. |
| 8 — GPT Image 2 polish | Not started | Phase 7 completion revision | — | — | — | Optional; procedural fallback must remain valid. |
