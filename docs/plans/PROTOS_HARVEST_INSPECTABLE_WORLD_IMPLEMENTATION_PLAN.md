...
| Phase 2 | Complete | `0c465b2c789c9a872b369da3066097361ab6e288` | Closed every current read route across **20** target families and **22** registered read operations; removed the unreachable `read_threat` alias; added authoritative home/storage occupancy summaries; made stewardship settlers directly inspectable; and delivered bilingual bounded facts for farm, social, wilderness, construction, deposit, and expedition targets. Compact viewports now use Details/Actions tabs with terminal-owned 44-pixel Back/Activate controls, two-step Back behavior, focusable controls, and duplicate activation suppression while wide layouts retain simultaneous Details and Actions. Passed inspection contracts **18/18**, interaction A **14/14**, interaction B **17/17**, interaction C **21/21**, settlement four **39/39**, settlement five **27/27**, settlement six **32/32**, aggregate smoke **2,140/2,140**, repository-wide lint/import/boot gates, and clean 1280×720 plus 720×1280 native visual checks. |
| Phase 3 | Complete | `6887d3a00b26a191e6e57b4e0c8c899822cdd368` | Added stable pond, safe-exit, irrigation-pump, and burrow-well projections without changing the ten resolver kinds or their priority. Pond reads expose water class, traversal, and irrigation relevance; the safe exit exposes destination/readiness/risk while its unsupported handoff remains truthfully disabled; utility props appear only when their owning capability renders them; decorative cells remain excluded. Integrated settlement Phase Seven and its normalized locale catalogs without losing read closure. Passed interaction B **21/21**, interaction C **21/21**, inspection contracts **18/18**, settlement seven **22/22**, bilingual key parity, aggregate smoke **2,145/2,145**, repository-wide lint/import/boot gates, and exact live pond captures at 1280×720 plus 720×1280. |
| Phase 4 | Complete | `b6c5367c2474b2a9607aae2a6cafe6503ace77a8` | Audited every world-runtime seam against existing ownership. The already-enabled tree/resource clear adapter is atomic across authoritative reward calculation, tool spend, bounded inventory capacity, world mutation ledger, persistence, live publication, rollback, repeat calls, and reload suppression. Added explicit forged-argument, full-inventory, persistence-failure, and one-shot publication-failure rollback checks. Pickup collection, hazard stabilization, remote-ruin activation, expedition-gate entry, and safe-exit handoff remain truthfully disabled because no existing adapter can yet guarantee durable state and live publication as one retry-safe outcome; no receipt budget was enlarged and no speculative authority was invented. Passed interaction B **23/23** and aggregate smoke **2,145/2,145** with repository-wide lint/import/boot gates. |
| Phase 5 | Complete | `d38e83750f32cd7f29ce0d3a607a733dccb4e0b5` gameplay release plus this documentation closure | Cached the immutable operation catalog and replaced full-terminal relayout after each read with incremental Decision Card sizing. Measured projection P95/P99 **0.865/0.939 ms**, read construction **1.129/1.219 ms**, and confirm-to-visible **6.576/7.053 ms**. The final candidate passed inspection **19/19**, interaction A **14/14**, interaction B **23/23**, interaction C **21/21**, aggregate smoke **2,146/2,146**, clean import/lint/bounded boot, full Web export, required artifact checks, and independent exported-PCK boot. Native landscape/portrait Terrain and Freshwater Pond captures passed. HTTP-served and WebDev-hosted builds reached title and field readiness, accepted live Inspect input, loaded exact PCK/WASM resources, retained the borderless fullscreen iframe, passed WebDev test/type/build checks, and rendered a settled 720×1280 portrait title without clipping. |
