...
ManusCC0 Regular, Medium and Bold remain the primary fonts. Their shared fallback is the complete, unsubsetted Noto Sans CJK SC Regular face at `assets/fonts/NotoSansCJKsc-ProtoIsometric.otf`. It contains 44,810 Unicode codepoints and 65,535 glyphs, including simplified/traditional Chinese and many personal-name characters. Full upstream coverage does not mean every Unicode CJK extension is present.
