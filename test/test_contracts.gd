...
const HarvestSettlementPhaseFiveTestsScript: GDScript = preload(
	"res://test/test_harvest_settlement_phase_five.gd"
)
const HarvestSettlementPhaseSixTestsScript: GDScript = preload(
	"res://test/test_harvest_settlement_phase_six.gd"
)
const HarvestSettlementPhaseSevenTestsScript: GDScript = preload(
	"res://test/test_harvest_settlement_phase_seven.gd"
)
const HarvestSettlementPhaseEightTestsScript: GDScript = preload(
	"res://test/test_harvest_settlement_phase_eight.gd"
)
const HarvestSettlementPhaseNineTestsScript: GDScript = preload(
	"res://test/test_harvest_settlement_phase_nine.gd"
)
const HarvestSettlementPhaseTenTestsScript: GDScript = preload(
	"res://test/test_harvest_settlement_phase_ten.gd"
)
...
static func evaluate(
	...
	cases.append_array(HarvestSettlementPhaseFiveTestsScript.evaluate_contracts())
	cases.append_array(HarvestSettlementPhaseSixTestsScript.evaluate_contracts())
	cases.append_array(HarvestSettlementPhaseSevenTestsScript.evaluate_contracts())
	cases.append_array(HarvestSettlementPhaseEightTestsScript.evaluate_contracts())
	cases.append_array(HarvestSettlementPhaseNineTestsScript.evaluate_contracts())
	cases.append_array(HarvestSettlementPhaseTenTestsScript.evaluate_contracts())
	return cases
