...
const DESERT: AudioStream = preload("res://assets/audio/bgm_desert.ogg")
const WETLAND: AudioStream = preload("res://assets/audio/bgm_wetland.ogg")
const FROZEN: AudioStream = preload("res://assets/audio/bgm_frozen.ogg")
